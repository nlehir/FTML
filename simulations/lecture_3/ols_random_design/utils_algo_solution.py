...
def generate_output_data(
    ...
    """
    n_train = X.shape[1]
    noise = rng.normal(0, sigma, size=(n_repetitions, n_train, 1))
...
def ols_test_error(
    ...
    # Bayes predictor
    theta_star = rng.normal(loc=0, scale=1, size=(d, 1))

    # train design matrix
    X_train = rng.uniform(low=0, high=1, size=(n_repetitions, n_train, d))
