...
If we have a solution function $f$ for an initialization at $0$, then for any other initialization, we can just shift this function and consider $g(x)=f(x-x_0)$.

\exercice{\textbf{}}

Sum and compositions of convex and linear functions.
\\
